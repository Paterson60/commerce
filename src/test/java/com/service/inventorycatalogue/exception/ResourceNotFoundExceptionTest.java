...
class ResourceNotFoundExceptionTest {
    ...
    public void test_exception_message_contains_correct_details() {
        ...
        com.service.inventorycatalogue.exception.ResourceNotFoundException exception = new com.service.inventorycatalogue.exception.ResourceNotFoundException(resourceName, fieldName, fieldValue);
    ...
    public void test_exception_message_handles_null_resource_name() {
        ...
        com.service.inventorycatalogue.exception.ResourceNotFoundException exception = new ResourceNotFoundException(resourceName, fieldName, fieldValue);
